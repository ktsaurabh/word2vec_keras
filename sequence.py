...
def cbows(sequence, vocabulary_size, 
    ...
    ''' 
        Take a sequence (list of indexes of words), 
        returns couples of [word_index, word_index-length+1, word_index-length+2, .., word_index+length-1] and labels (1s or 0s),
        where label = 1 if 'word' belongs to the context with 'length' of 'word',
        and label=0 if 'word' is ramdomly sampled
